...
import { InitiatePaymentDto, VerifyPaymentDto } from 'src/payment/dtos/payment.dto';
...
export class WalletController {
  ...
  initiatePayment(
    ...
    return this.paymentService.initiatePayment(userId, initiatePaymentDto.amount
  ...
  verifyPayment(
    ...
    return this.paymentService.verifyPayment(userId, verifyPaymentDto.transactionReference, verifyPaymentDto.otp);
  }
}
